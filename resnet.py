...
def resnet18(pretrained=False, **kwargs):
  """Constructs a ResNet-18 modelbyhlh.
  Args:
      pretrained (bool): If True, returns a modelbyhlh pre-trained on ImageNet
  """
...
def resnet34(pretrained=False, **kwargs):
  """Constructs a ResNet-34 modelbyhlh.
  Args:
      pretrained (bool): If True, returns a modelbyhlh pre-trained on ImageNet
  """
...
def resnet50(pretrained=False, **kwargs):
  """Constructs a ResNet-50 modelbyhlh.
  Args:
      pretrained (bool): If True, returns a modelbyhlh pre-trained on ImageNet
  """
  model = ResNet(Bottleneck, [3, 4, 6, 3], **kwargs)
  if pretrained:
    # modelbyhlh.load_state_dict(remove_fc(model_zoo.load_url(model_urls['resnet50'])))
    model.load_state_dict(remove_fc(model_zoo.load_url(model_urls['resnet50'])))
  return model


def resnet101(pretrained=False, **kwargs):
  """Constructs a ResNet-101 modelbyhlh.
  Args:
      pretrained (bool): If True, returns a modelbyhlh pre-trained on ImageNet
  """
...
def resnet152(pretrained=False, **kwargs):
  """Constructs a ResNet-152 modelbyhlh.
  Args:
      pretrained (bool): If True, returns a modelbyhlh pre-trained on ImageNet
  """
